...
**What is the F3A Pattern Aerobatics RC Club?**  
The F3A Pattern Aerobatics RC Club is a resource to support the establishment of future F3A Clubs or F3A websites, or both. It aims to help create an F3A-friendly RC Club with a clean and robust website, similar to [f3a-pattern-aerobatics-rc.club](https://f3a-pattern-aerobatics-rc.club).
